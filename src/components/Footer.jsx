        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                                 <Link to="/" onClick={scrollToTop} className="text-blue-200 hover:text-orange-400 transition-all duration-300 flex items-center group font-medium">
              ...
              <li>
                                 <Link to="/about" onClick={scrollToTop} className="text-blue-200 hover:text-orange-400 transition-all duration-300 flex items-center group font-medium">
                   <span className="w-2 h-2 bg-blue-400 rounded-full mr-3 group-hover:bg-orange-400 transition-colors duration-300"></span>
              ...
              <li>
                                 <Link to="/how-it-works" onClick={scrollToTop} className="text-blue-200 hover:text-orange-400 transition-all duration-300 flex items-center group font-medium">
                   <span className="w-2 h-2 bg-blue-400 rounded-full mr-3 group-hover:bg-orange-400 transition-colors duration-300"></span>
              ...
              <li>
                                 <Link to="/contact" onClick={scrollToTop} className="text-blue-200 hover:text-orange-400 transition-all duration-300 flex items-center group font-medium">
                   <span className="w-2 h-2 bg-blue-400 rounded-full mr-3 group-hover:bg-orange-400 transition-colors duration-300"></span>
              ...
              <div className="grid grid-cols-2 gap-x-12 gap-y-2 text-sm">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <FaSeedling className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">S</span>
                                         <span className="text-blue-200 text-xs font-medium">- Stability</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full flex-shrink-0"></div>
                    <FaTree className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">U</span>
                                         <span className="text-blue-200 text-xs font-medium">- Unity</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-orange-400 rounded-full flex-shrink-0"></div>
                    <FaLeaf className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">N</span>
                                         <span className="text-blue-200 text-xs font-medium">- Nurture</span>
                  </div>
                </div>
                {/* Second Column */}
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <FaSeedling className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">S</span>
                                         <span className="text-blue-200 text-xs font-medium">- Self-Accountability</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full flex-shrink-0"></div>
                    <FaTree className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">H</span>
                                         <span className="text-blue-200 text-xs font-medium">- Hope</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-orange-400 rounded-full flex-shrink-0"></div>
                    <FaLeaf className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">I</span>
                                         <span className="text-blue-200 text-xs font-medium">- Integrity</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-blue-400 rounded-full flex-shrink-0"></div>
                    <FaSeedling className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">N</span>
                                         <span className="text-blue-200 text-xs font-medium">- New Beginnings</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full flex-shrink-0"></div>
                    <FaSeedling className="w-3 h-3 text-green-400 flex-shrink-0" />
                    <span className="text-blue-200 font-semibold flex-shrink-0">E</span>
                                         <span className="text-blue-200 text-xs font-medium">- Empowerment</span>
                  </div>
                </div>
              </div>
            </div>
